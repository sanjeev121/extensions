...
function onPageLoaded(){
    ...
    // return false;
    chrome.runtime.sendMessage({showToolbar:true}, function(res){
        if(res == 'TOOLBAR_SHOWN'){
            ...
            chrome.runtime.sendMessage({isLinkedInAvailable : true}, function(res){
                if(res == 0){
                    $("#get_details").show();
                    $("#outer_form").hide();
                } else {
                ...
                chrome.storage.local.get("isSignUpRequired", function(o){
                    if(o && o.isSignUpRequired == true){
                        ...
                        $("#outer_form").show();
                        $("#det_popup").hide();
                        chrome.storage.local.get('isSalesNav', function(o){
                            if(o && o.isSalesNav){
                ...
                if($(this).hasClass("button_stop")){
                    ...
                    if($(this).hasClass("upgrade_membership")) {
                        ...
                        if($(this).data('control-type') == 'sales'){
                            chrome.tabs.create({url : LINKED_SALES_SEARCH_PAGE});
                        } else {
            ...
            $(".new_tab").bind("click", function(){
                ...
                if(url){
                    ...
                    chrome.tabs.create({url : chrome.runtime.getURL('CRM/index.html#/details')});
                }
            });
        }
    })
